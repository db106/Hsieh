...
# 製作/存取儲存路徑
information_path = r'./Taipei_Qyer'
if not os.path.exists(information_path) :
    os.mkdir(information_path)

headers = {'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36'}
request_url = 'https://place.qyer.com/poi.php?action=list_json'     # json網頁
...
for i in range(1,101) :     # 標題頁面1至100頁
    ...
    for j in range(0,15) :     # 每頁標題有15個
        ...
        try :
            ...
            each_location = each_soup.select('#app > div > div.q-container > div > div.main-bg > div > div.compo-main > div.compo-detail-info > ul > li:nth-child(1) > div > p')[0].text     # 景點地址
        ...
        # Taipei_site_info = dict(zip(all_keys, all_values))
        # js_info = json.dumps(Taipei_site_info, ensure_ascii=False)
        ...
        with open(r'./Taipei_Qyer/Taipei_Qsite/Taipei_site.json', 'a', encoding='utf-8') as w :
        ...
        with open(r'./Taipei_Qyer/Taipei_Qsite/Taipei_%s.txt'%(txt_name), 'a', encoding='utf-8') as t :
