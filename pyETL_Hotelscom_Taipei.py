...
url = 'https://tw.hotels.com/search.do?resolved-location=CITY%3A1366745%3AUNKNOWN%3AUNKNOWN&destination-id=1366745&q-destination=%E5%8F%B0%E5%8C%97,%20%E5%8F%B0%E7%81%A3&q-check-in={}&q-check-out={}&q-rooms=1&q-room-0-adults=2&q-room-0-children=0'.format(start_date, end_date)
...
driver.get(url=url)
for page in range(1, 300):     # 模擬滾動300次
...
for i, title in enumerate(titles) :
    ...
    with open(r'./hotels_com/HC_Taipei/hotelcom_Taipei.json', 'a', encoding='utf-8') as w:
        w.write(json_data + '-----')

    with open(r'./hotels_com/HC_Taipei/hotelscom_Taipei_%s.txt' % (title.text), 'a', encoding='utf-8') as t:
        t.write(json_data)