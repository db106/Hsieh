...
url = 'https://tw.hotels.com/search.do?resolved-location=CITY%3A1636763%3AUNKNOWN%3AUNKNOWN&destination-id=1636763&q-destination=%E6%96%B0%E7%AB%B9%E5%B8%82,%20%E5%8F%B0%E7%81%A3&q-check-in={}&q-check-out={}&q-rooms=1&q-room-0-adults=2&q-room-0-children=0'.format(start_date, end_date)
...
for i, title in enumerate(titles) :
    ...
    with open(r'./hotels_com/HC_Hsinchu/hotelcom_Hsinchu.json', 'a', encoding='utf-8') as w:
        w.write(json_data + '-----')

    with open(r'./hotels_com/HC_Hsinchu/hotelscom_Hsinchu_%s.txt' % (title.text), 'a', encoding='utf-8') as t:
        t.write(json_data)